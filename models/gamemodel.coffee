class Game
	constructor: (sourceEntity)->
		...
		@titleMediaUri 	= if sourceEntity.titleMediaUri._ is undefined then "#{ mediaLocation}#{sourceEntity.titleMediaUri}" else "#{ mediaLocation}#{sourceEntity.titleMediaUri._}"
